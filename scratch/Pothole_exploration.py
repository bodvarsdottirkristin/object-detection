    ...
    def visualize_annotations(self, image_filename, output_dir=None, figsize=(12, 8)):
        ...
        if annotation is not None and annotation['bboxes']:
            for bbox in annotation['bboxes']:
                ...
                # Add label
                ax.text(x_min, y_min - 5, bbox['class'],
    ...
    def get_dataset_statistics(self, split='train'):
        ...
        for filename in files:
            ...
            if xml_path.exists():
                ...
                stats['image_dimensions'].append((annotation['width'], annotation['height']))
        ...
        if stats['num_images'] > 0:
            stats['avg_potholes_per_image'] = stats['num_potholes'] / stats['num_images']
...
if __name__ == "__main__":
    ...
    try:
        ...
        import random
        random_files = random.sample(dataset.train_files, min(3, len(dataset.train_files)))
